...
// Mirrors search/page.tsx: heading + search input, then one bordered,
// divided result group (icon + two lines per row, no trailing chip - the
// real rows have none either).
