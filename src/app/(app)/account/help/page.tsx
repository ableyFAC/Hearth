          ...
          {FAQ.map((f) => (
            <details key={f.q} className="group py-3">
              ...
              {f.href && (
                <a
                  href={f.href}
                  className="mt-2 inline-block text-sm font-medium text-hearth-700 hover:underline"
                >
                  {f.hrefLabel} →
                </a>
              )}
      ...
      {FOUNDER.email && (
        <div className="card">
          ...
          <a
            ...
            className="mt-3 inline-block text-sm font-medium text-hearth-700 hover:underline"
          >
            Report a bug
          </a>
        </div>
