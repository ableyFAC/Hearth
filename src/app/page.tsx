    ...
    <main className="mx-auto max-w-3xl px-6 pb-16 pt-6">
      ...
      <div className="mt-14 flex flex-col items-center text-center">
        ...
        <p className="mt-4 max-w-xl text-lg text-stone-600">
          Hearth watches over your house, tells you what needs attention, and
          finds a trusted pro when something breaks.
        </p>
        <a href="/get-started" className="btn-primary mt-8 px-6 py-3 text-base">
          Get started free
        </a>
        <p className="mt-2 text-xs text-stone-500">
          About 30 seconds. No card needed.
        </p>
        <a
          href="/signin"
      ...
      <section className="mt-16 flex flex-col items-center">
        <div className="w-full max-w-sm rounded-xl border border-stone-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-4xl font-bold text-hearth-700">72</p>
